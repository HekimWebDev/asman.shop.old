    ...
    function g(b, c) {
        ...
        return (
            a.each(c, function (a, c) {
                ...
                if (b.which === c.which) {
                    var e =
                            !c.hasOwnProperty("altKey") ||
                            b.altKey === c.altKey,
                        f =
                            !c.hasOwnProperty("shiftKey") ||
                            b.shiftKey === c.shiftKey,
                        g =
                            !c.hasOwnProperty("ctrlKey") ||
                            b.ctrlKey === c.ctrlKey;
    ...
    (b.prototype = {
        ...
        add: function (b, c, d) {
            ...
            if (
                !(
                    f.options.maxTags &&
                    f.itemsArray.length >= f.options.maxTags
                ) &&
                (b === !1 || b)
            ) {
                if (
        ...
        remove: function (b, c, d) {
                    ...
                    ((b =
                        "object" == typeof b
                            ? a.grep(e.itemsArray, function (a) {
                                  return (
                                      e.options.itemValue(a) ==
                                      e.options.itemValue(b)
                                  );
                              })
                            : a.grep(e.itemsArray, function (a) {
            ...
            c || e.pushVal(),
                ...
                e.$element.trigger(
                    a.Event("itemRemoved", { item: b, options: d })
                );
        },
        removeAll: function () {
            var b = this;
            for (
                a(".tag", b.$container).remove(),
                    a("option", b.$element).remove();
            ...
            e.$container.on(
                ...
                e.$container.on(
                    ...
                    a.proxy(function (b) {
                        ...
                        c.attr(
                            "size",
                            Math.max(this.inputSize, c.val().length)
                        );
                    }, e)
                ),
                e.$container.on(
                    ...
                    a.proxy(function (b) {
                        ...
                        var d = c.val(),
                            f =
                                e.options.maxChars &&
                                d.length >= e.options.maxChars;
                        e.options.freeInput &&
                            (g(b, e.options.confirmKeys) || f) &&
                            (0 !== d.length &&
                                (e.add(f ? d.substr(0, e.options.maxChars) : d),
                                c.val("")),
                            e.options.cancelConfirmKeysOnEmpty === !1 &&
                                b.preventDefault());
                        var h = c.val().length;
                        Math.ceil(h / 5);
                        c.attr(
