                    ...
                    <form method="POST" action="{{ route('admin.sliders.update', $slider->id) }}"
                        ...
                        @if ($slider->translate('tk')->image)
                            <div class="mx-auto w-50">
                                ...
                                @include('admin.components.image', ['image' => $slider->translate('tk')->image])
                            </div>
                        @endif
                        ...
                        @if ($slider->translate('en')->image)
                            <div class="mx-auto w-50">
                                ...
                                @include('admin.components.image', ['image' => $slider->translate('en')->image])
                            </div>
                        @endif
                        ...
                        @if ($slider->translate('ru')->image)
                            <div class="mx-auto w-50">
                                ...
                                @include('admin.components.image', ['image' => $slider->translate('ru')->image])
                            </div>
                        @endif
